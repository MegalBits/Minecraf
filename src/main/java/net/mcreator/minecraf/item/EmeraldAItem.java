...
public class EmeraldAItem extends MinecrafModElements.ModElement {
	@ObjectHolder("minecraf:emerald_a_helmet")
	public static final Item helmet = null;
	@ObjectHolder("minecraf:emerald_a_chestplate")
	public static final Item body = null;
	@ObjectHolder("minecraf:emerald_a_leggings")
	public static final Item legs = null;
	@ObjectHolder("minecraf:emerald_a_boots")
	public static final Item boots = null;
	public EmeraldAItem(MinecrafModElements instance) {
		super(instance, 18);
	}
