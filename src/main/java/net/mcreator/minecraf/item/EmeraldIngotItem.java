...
public class EmeraldIngotItem extends MinecrafModElements.ModElement {
	@ObjectHolder("minecraf:emerald_ingot")
	public static final Item block = null;
	public EmeraldIngotItem(MinecrafModElements instance) {
		super(instance, 14);
	}
