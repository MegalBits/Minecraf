...
public class WoodenItem extends MinecrafModElements.ModElement {
	@ObjectHolder("minecraf:wooden_helmet")
	public static final Item helmet = null;
	@ObjectHolder("minecraf:wooden_chestplate")
	public static final Item body = null;
	@ObjectHolder("minecraf:wooden_leggings")
	public static final Item legs = null;
	@ObjectHolder("minecraf:wooden_boots")
	public static final Item boots = null;
	public WoodenItem(MinecrafModElements instance) {
		super(instance, 28);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(MinecrafItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "minecraf:textures/models/armor/wooden__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
