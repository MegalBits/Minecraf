...
package net.mcreator.minecraf.entity;
...
import net.mcreator.minecraf.entity.renderer.CrepigRenderer;
import net.mcreator.minecraf.MinecrafModElements;

@MinecrafModElements.ModElement.Tag
public class CrepigEntity extends MinecrafModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 0.9f)).build("crepig").setRegistryName("crepig");
	public CrepigEntity(MinecrafModElements instance) {
		super(instance, 36);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CrepigRenderer.ModelRegisterHandler());
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 10, 3, 8));
	}
