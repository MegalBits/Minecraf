...
import net.mcreator.minecraf.procedures.FishBarrelBlockDestroyedByPlayerProcedure;
...
public class FishBarrelBlock extends MinecrafModElements.ModElement {
	@ObjectHolder("minecraf:fish_barrel")
	public static final Block block = null;
	public FishBarrelBlock(MinecrafModElements instance) {
		super(instance, 8);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("fish_barrel");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				FishBarrelBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("minecraf:fish_barrel_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("fish_barrel"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("minecraf:fish_barrel"), configuredFeature);
		}
	}
	@SubscribeEvent
